...
- (void)viewDidLoad
{
    ...
    self.tableView = [[ADBIndexedTableView  alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) style:UITableViewStylePlain];
    ...
    NSDictionary *obj13 = @{ @"name" : @"Vera" };
      NSDictionary *obj14 = @{ @"name" : @"Qiugaoying" };
    
    // unsorted objects
    NSArray *objects = @[obj1,obj1,obj1,obj1,obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12, obj13,obj2,obj4,obj8,obj12,obj10,obj9,obj9,obj14];
